...
import shoopingCard from "../assets/shopping-cart.png";
  ...
  return (
    <nav className="bg-gray-900 text-white px-2 py-3">
      <div className="flex items-center justify-between gap-4">
        {/* Logo */}
        <div className="w-30">
          <img src={amazonLogo} className="nav-hover" />
        </div>
        ...
        <div className="hidden lg:flex items-center gap-1 nav-hover">
          <img src={englishFlag} className="w-7" />
          <span className="font-bold text-[14px]">EN</span>
          <img src={arrow} className="w-2 mt-1 " />
        </div>
        ...
        <div className="hidden md:flex flex-col text-[12px] nav-hover">
          ...
          <div className="flex items-center ">
            ...
            <img src={arrow} className="w-2 ml-1 " />
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 nav-hover">
          <img src={shoopingCard} className="w-6" />
